...
class Controlcentre extends CI_Controller {
	...
	public function login() {
		...
		$this->load->view('controlcentre/login', $data);
	}
	...
	public function dashboard() {
		...
		$this->load->view('controlcentre/dashboard', $response);
	}
	...
	public function addMember() {
		...
		$this->load->view('controlcentre/members/add_member', $response);
	}
	...
	function contacts() {
		$this->load->view('controlcentre/contacts');
	}
	...
	public function createEvent() {
		...
		$this->load->view('controlcentre/programmes/create_program', $response);
	}
	...
	public function createDept() {
		...
		$this->load->view('controlcentre/programmes/create_dept', $response);
	}
	...
	public function dailyDeclarations() {
		...
		$this->load->view('controlcentre/declarations/view', $data);
	}
	...
	public function insertSmsConfig() {
		...
		//redirect(base_url('controlcentre/configSms'));
		//Loading View
		$this->load->view('controlcentre/configurations/sms/sms_settings', $response);
	}
	/* /this section handles the configurations part */
